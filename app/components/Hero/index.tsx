    ...
    <section className="mb-8">
      <div className="md:h-[576px] h-[175px] bg-cover bg-[url('/landingpage/hero.webp')] md:px-[230px] items-center text-center pt-[70px] md:pt-[180px]">
        ...
        <div className="">
          <input
            type="text"
            className="relative rounded-full pl-10 md:pl-[44px] pr-4 py-2 w-[260px] md:w-[615px] h-[40px] md:h-[60px] focus:outline-none focus:ring-2 focus:ring-blue-500 text-[15px] md:text-[20px] mt-[10px] md:mt-[20px]"
            placeholder="Search..."
          />
          <button className="absolute left-[60px] md:left-[545px] top-[118px] md:top-[270px] ml-2">
            <svg
              stroke="currentColor"
              fill="currentColor"
              stroke-width="0"
          ...
          <div className=" hidden md:block">
            <div className="flex gap-4 justify-center mt-10">
              ...
              <div>
                ...
                <p className="text-white font-[600] text-[14px]">Exhibition</p>
              </div>
            </div>
          </div>
        </div>
